...
* <b>Do I need to configure "--with-tdsver" equal to anything?</b> No! This is only a default for clients/configs that do not specify what TDS version they want to use. You do not need to worry about it!
