...
Installing with rubygems should just work. TinyTDS is tested on ruby version 1.8.6, 1.8.7, 1.9.1, 1.9.2 as well as REE & JRuby(we currently don't have jdbc support, so even using JRuby, you should install FreeTDS before trying to install tiny_tds gem).
