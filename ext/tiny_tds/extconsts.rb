...
FREETDS_VERSION = ENV['TINYTDS_FREETDS_VERSION'] || "1.0rc2"
FREETDS_VERSION_INFO = Hash.new { |h,k|
  h[k] = {files: "ftp://ftp.freetds.org/pub/freetds/stable/freetds-#{k}.tar.bz2"}
}
FREETDS_VERSION_INFO['1.0rc2'] = {files: 'ftp://ftp.freetds.org/pub/freetds/stable/release_candidates/freetds-1.0rc2.tar.bz2'}
